...
var target, service, doSaveCalled, doRollbackCalled;

module('Integration: eb-bucket with auto save enabled', {
  setup: function() {
...
test('Controller automatically saves bucket contents', function() {
  expect(7);
  visit('/buckets');
  andThen(function() {
